							...
							<div class="col-md-4 text-center">
								<div class="product-entry">
									<div class="product-img" style="background-image: url(source/images/item-5.jpg);">
										...
										<div class="cart">
											<p>
												<span class="addtocart"><a href="source/cart.html"><i class="icon-shopping-cart"></i></a></span> 
												<span><a href="source/product-detail.html"><i class="icon-eye"></i></a></span> 
												<span><a href="#"><i class="icon-heart3"></i></a></span>
												<span><a href="source/add-to-wishlist.html"><i class="icon-bar-chart"></i></a></span>
											</p>
										</div>
									</div>
									<div class="desc">
										<h3><a href="source/product-detail.html">Floral Dress</a></h3>
